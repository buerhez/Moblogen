...
class Pagination extends Widget{
    ...
    <span class="page-number">Page 2 / Total 7 pages</span>
    ...
    public function run(){
        ...
        $this->_htmlStr.=Html::tag('span',sprintf('Page %d / Total %d pages',$this->_currentPage+1,$this->_pageCount),['class'=>'page-number']);
