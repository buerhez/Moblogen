...
if ($exception instanceof \yii\web\HttpException) {
    ...
    switch($code){
        case 404 :$message='Page not found or deleted';break;
        case 500 :$message='Server internal error';break;
        default:$message='Sorry, an error has occurred';
    }
} else {
        ...
        <section class="error-content error-404 js-error-container">
            <section class="error-details">
                ...
                <section class="error-message">
                    ...
                    <a class="error-link" href="<?=\yii\helpers\Url::home()?>">Return to homepage →</a>
                </section>
            </section>
        </section>
    </div>
